...
export type IPlaceholderDarkProps = ViewProps & {
  loading: boolean;
...
const styles = StyleSheet.create({
  ...
  line: {
    backgroundColor: Colors.system('gray', 'dark'),
    height: 16,
    marginBottom: 6,
    width: '100%',
    borderRadius: 5,
...
const PlaceholderDark: React.FunctionComponent<IPlaceholderDarkProps> = props => {
...
export default PlaceholderDark;
